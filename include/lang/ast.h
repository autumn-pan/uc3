...
/*
A UC3 project is one that consists of a central project, with multiple
subsystems. Each subsystem each have multiple components attached. A component
can be any piece of code, whether central to the subsystem or an optional
plugin. This is designed such that components are interchangable, leading to a
